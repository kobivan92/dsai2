...
│  │                                                                     │   │
│  │  Statistical Parity Difference: 0-3 points                         │   │
│  │  Disparate Impact: 0-3 points                                      │   │
│  │  Mean Difference: 0-3 points                                       │   │
│  │                                                                     │   │
│  │  🟢 LOW (0-2): Minimal bias detected + LLM                              │   │
│  │  🟡 MEDIUM (3-4): Moderate bias detected + LLM                          │   │
│  │  🟠 HIGH (5-6): Significant bias detected + LLM                       │   │
│  │  🔴 CRITICAL (7-9): Severe bias detected  + LLM                        │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────────────────┘
    │
    ▼
